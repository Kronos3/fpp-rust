use crate::semantics::{AbsTypeValue, AnonArrayValue, AnonStructValue, ArrayValue, BooleanValue, EnumConstantValue, FloatValue, Format, IntegerValue, PrimitiveIntegerValue, StringValue, StructValue, Value};
...
impl Type {
    ...
    // fn is_convertible_to(&self, t: Type) -> bool {
    //     Type.mayBeConverted(this -> t)
    // }
}
