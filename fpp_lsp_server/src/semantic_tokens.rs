...
impl SemanticTokenKind {
    fn token_type(self) -> SemanticTokenKindRaw {
        match self {
            ...
            SemanticTokenKind::InputPortInstance => SemanticTokenKindRaw::Function,
            SemanticTokenKind::OutputPortInstance => SemanticTokenKindRaw::Function,
            SemanticTokenKind::InputPort => SemanticTokenKindRaw::Function,
            SemanticTokenKind::OutputPort => SemanticTokenKindRaw::Function,
            SemanticTokenKind::SpecialPort => SemanticTokenKindRaw::Function,
